...
from market_data_mcp.models.sector import SectorItem, SectorBoardsData
from market_data_mcp.models.capital_flow import CapitalFlowData
...
class EastMoneySource(BaseDataSource):
    ...
    def fetch_northbound_flow(self, days: int = 20) -> "NorthboundFlowData":
        ...
        from market_data_mcp.models.flow import NorthboundFlowData, FlowDataPoint
    ...
    def fetch_dragon_tiger_list(self) -> "DragonTigerData":
        ...
        from market_data_mcp.models.enhance import DragonTigerData, DragonTigerItem
    ...
    def fetch_sector_constituents(self, sector_code: str) -> "SectorConstituentsData":
        ...
        from market_data_mcp.models.enhance import SectorConstituentsData, ConstituentItem
