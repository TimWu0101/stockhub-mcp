...
from market_data_mcp.domain.symbol.resolver import SymbolResolver, StandardSymbol
...
async def get_financial_statements_impl(
    ...
    try:
        ...
        from market_data_mcp.models.finance import (
...
async def get_valuation_metrics_impl(
    ...
    try:
        ...
        from market_data_mcp.models.finance import ValuationMetricsData, QualityMetricsData
...
async def get_quality_metrics_impl(
    ...
    try:
        ...
        from market_data_mcp.models.finance import QualityMetricsData
...
async def get_dividends_splits_impl(
    ...
    try:
        ...
        from market_data_mcp.models.research import DividendsSplitsData, DividendItem, SplitItem
        divs = t.dividends
        splits = t.splits
...
async def get_holders_impl(
    ...
    try:
        ...
        from market_data_mcp.models.research import HoldersData, HolderItem
...
async def get_analyst_forecasts_impl(
    ...
    try:
        ...
        from market_data_mcp.models.research import AnalystForecastsData, ForecastItem
...
async def get_options_chain_impl(
    ...
    try:
        ...
        from market_data_mcp.models.research import OptionsChainData, OptionItem
...
async def get_index_quote_impl(symbol: str) -> dict[str, Any]:
    ...
    try:
        ...
        from market_data_mcp.models.research import IndexQuoteData
        data = IndexQuoteData(
...
async def compare_stocks_impl(symbols: list[str]) -> dict[str, Any]:
    ...
    try:
        import yfinance as yf
        from market_data_mcp.models.finance import CompareStocksData, CompareItem
...
async def compare_indices_impl(indices: list[str]) -> dict[str, Any]:
    ...
    try:
        import yfinance as yf
        from market_data_mcp.models.research import CompareIndicesData, IndexCompareItem
